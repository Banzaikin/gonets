...
/* ./.libs/lt-dump_data.c - temporary wrapper executable for .libs/dump_data.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-15build2

   The dump_data program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "dump_data.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# dump_data - temporary wrapper script for .libs/dump_data.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-15build2\n", f);
  fputs ("#\n", f);
  fputs ("# The dump_data program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"dump_data.exe:dump_data:$LINENO: libtool wrapper (GNU libtool) 2.4.6 ", f);
  fputs ("Debian-2.4.6-15build2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"dump_data.exe:dump_data:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"dump_data.exe:dump_data:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
