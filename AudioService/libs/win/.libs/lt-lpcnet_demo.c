...
/* ./.libs/lt-lpcnet_demo.c - temporary wrapper executable for .libs/lpcnet_demo.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-15build2

   The lpcnet_demo program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/home/andrey/lpcnet/2/LPCNet/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/andrey/lpcnet/2/LPCNet/.libs;/usr/local/lib;/usr/local/bin;";
const char * TARGET_PROGRAM_NAME = "lpcnet_demo.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.6 Debian-2.4.6-15build2\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# lpcnet_demo - temporary wrapper script for .libs/lpcnet_demo.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-15build2\n", f);
  fputs ("#\n", f);
  fputs ("# The lpcnet_demo program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' liblpcnet.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"lpcnet_demo.exe:lpcnet_demo:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.6 Debian-2.4.6-15build2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"lpcnet_demo.exe:lpcnet_demo:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"lpcnet_demo.exe:lpcnet_demo:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
  ...
  fputs ("    PATH=/home/andrey/lpcnet/2/LPCNet/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/andrey/lpcnet/2/LPCNet/.libs:$PATH\"\n", f);
  fputs ("\n", f);
